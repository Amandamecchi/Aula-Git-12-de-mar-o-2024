//Definimos a string original que contém a frase "OLA MUNDO".
...
console.log(semAcento);// "OLA MUNDO"
console.log("Número total de vogais:", quantasVogaisTem);//Número total de vogais: 4 
//O método join('-') para converter o array em uma string, onde cada elemento é separado por uma vírgula seguida de um espaço. 
console.log("Vogais encontradas:", qualVogal.join(', '));//Vogais encontradas: O - A - U - O.
